const data= [
  ...
  const display = () => {
    ...
    document.getElementById("myProducts").innerHTML = display.join("");
  }
  display();

  myFunction = ()=> {
    
    let searchTerm = document.getElementById("myFilter").value;
    let myFunction = data.filter((v)=> {

        return v.position.includes(searchTerm);
    });
...
data.sort(function(a,b) {
  if(a.length.company > b.length.company)
  {
    return 1;
  }
  else
